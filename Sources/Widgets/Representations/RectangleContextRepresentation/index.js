...
function vtkRectangleContextRepresentation(publicAPI, model) {
  ...
  publicAPI.requestData = (inData, outData) => {
    ...
    if (state.getVisible()) {
      ...
      points[1] = point1[1];
      points[2] = point1[2];
      points[3] = point1[0] + rightComponent * right[0];
      points[4] = point1[1] + rightComponent * right[1];
      points[5] = point1[2] + rightComponent * right[2];
      points[6] = point2[0];
      points[7] = point2[1];
      points[8] = point2[2];
      points[9] = point1[0] + upComponent * up[0];
      points[10] = point1[1] + upComponent * up[1];
      points[11] = point1[2] + upComponent * up[2];
